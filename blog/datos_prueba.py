...
pc1 = Producto(id_producto=1, nombre='jalapy_chocolate_box', precio=800, documento_admin_id=1085987365)
pc1.save()
...
pc2 = Producto(id_producto=2, nombre='pasti white chocolate box', precio=800, documento_admin_id=1085987365)
pc2.save()
...
pc3 = Producto(id_producto=3, nombre='baileys chocolate box', precio=1400, documento_admin_id=1085987365)
pc3.save()
...
pc4 = Producto(id_producto=4, nombre='mojitos chocolate box', precio=400, document_admin_id=1085987365)
pc4.save()
...
pc5 = Producto(id_producto=5, nombre='anchoas_chocolate_arrangement', precio=700,
               documento_admin_id=1085987365)
pc5.save()
...
pc6 = Producto(id_producto=6, nombre='citrus_chocolate_arrangement', precio=900,
               documento_admin_id=1085987365)
pc6.save()
...
pc7 = Producto(id_producto=7, nombre='coco_chocolate_arrangement', precio=700, documento_admin_id=1085987365)
pc7.save()
...
# GOMITAS
pg1 = Producto(id_producto=8, nombre='Corazoncitos', precio=250, documento_admin_id=1085987365)
pg1.save()
...
pg2 = Producto(id_producto=9, nombre='Egipt', precio=360, documento_admin_id=1085987365)
pg2.save()
...
pg3 = Producto(id_producto=10, nombre='Rellenitos', precio=340, documento_admin_id=1085987365)
pg3.save()
...
pg4 = Producto(id_producto=11, nombre='Selva', precio=1000, documento_admin_id=1085987365)
pg4.save()
...
pg5 = Producto(id_producto=12, nombre='Sandicin', precio=310, documento_admin_id=1085987365)
pg5.save()
...
pg6 = Producto(id_producto=13, nombre='Ossy', precio=2600, documento_admin_id=1085987365)
pg6.save()
...
pg7 = Producto(id_producto=14, nombre='Saltarin', precio=3000, documento_admin_id=1085987365)
pg7.save()
gp7 = Goma(id_producto_id=14, sabor='Mora', tipo='Rana')
gp7.save()
g7 = ArregloGoma(id_producto_id=14, precio=40000, tema='Halloween', expedicion=datetime.date(2021, 10, 10), peso=4000,
                 empaque='Bolsa')
g7.save()

pg8 = Producto(id_producto=15, nombre='Coquito', precio=1700, documento_admin_id=1085987365)
pg8.save()
...
# FLORES
pf1 = Producto(id_producto=16, nombre='ramo_rosas', precio=2000, documento_admin_id=1085987365)
pf1.save()
f1 = Flor(id_producto_id=16, peso=6000, precio=26000, cantidad=12)
f1.save()

pf2 = Producto(id_producto=17, nombre='ramo_girasoles', precio=8000, documento_admin_id=1085987365)
pf2.save()
f2 = Flor(id_producto_id=17, peso=9000, precio=50000, cantidad=6)
f2.save()

pf3 = Producto(id_producto=18, nombre='ramo_mix', precio=10000, documento_admin_id=1085987365)
pf3.save()
f3 = Flor(id_producto_id=18, peso=6000, precio=60000, cantidad=17)
f3.save()

pf4 = Producto(id_producto=19, nombre='caja_rosas', precio=2000, documento_admin_id=1085987365)
pf4.save()
f4 = Flor(id_producto_id=19, peso=12000, precio=75000, cantidad=24)
f4.save()

pf5 = Producto(id_producto=20, nombre='caja_mix', precio=10000, documento_admin_id=1085987365)
pf5.save()
f5 = Flor(id_producto_id=20, peso=10000, precio=67000, cantidad=24)

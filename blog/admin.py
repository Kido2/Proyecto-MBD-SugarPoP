...
#CHOCOLATES
pc1 = Product(id_product = 1, product_name = 'jalapy_chocolate_box', unit_price = 800, document_admin = 1085987365)
pc1.save()
cp1=Chocolate(id_product=1,flavor='picante',type='artesanos')
cp1.save()
c1= Box_of_chocolates(id_product=1,category='artesano',weight=234,expedition_date=datetime.date(2020,07 ,17),
expiration_date=datetime.date(2021, 07,10),total_price=8300,number_of_units=10)
c1.save()
...
cp2.save()
c2= Box_of_chocolates(id_product=2,category='blanco',weight=218,expedition_date=datetime.date(2020, 09,23),
expiration_date=datetime.date(2021, 09,21),total_price=10400,number_of_units=13)
c2.save()
...
cp3.save()
c3= Box_of_chocolates(id_product=3,category='relleno',weight=357,expedition_date=datetime.date(2020, 04,26),
expiration_date=datetime.date(2021, 02,24),total_price=17.200,number_of_units=12)
c3.save()
...
cp4.save()
c4= Box_of_chocolates(id_product=4,category='negro',weight=278,expedition_date=datetime.date(2020, 10,08),
expiration_date=datetime.date(2020,09 ,11),total_price=6800,number_of_units=17)
c4.save()
...
cp5.save()
c5= Arrag_of_chocls(id_product=5,arrag_price=23500,theme='Amor y amistad',expedition_date=datetime.date(2020, 02,19),
...
cp6.save()
c6= Arrag_of_chocls(id_product=6,arrag_price=34800,theme='Dia de las madres',expedition_date=datetime.date(2020, 03,25),
...
cp7.save()
c7= Arrag_of_chocls(id_product=7,arrag_price=19900,theme='Amigo secreto',expedition_date=datetime.date(2020, 04,29),
...
gp6.save()
g6=Arrag_of_gummies(id_product=13, arrag_price=35000, expidition_date= default, theme='Verano', weight=1000, package='Canasta')
g6.save()
...
gp7.save()
g7=Arrag_of_gummies(id_producto=14, arrag_price=40000, expedition_date=default, theme='Halloween', weight=4000, package='Bolsa')
g7.save()
...
gp8.save()
g8=Arrag_of_gummies(id_product=15, flavor='Coco',type='Ositos', arrag_price=37500, expedition_date=default, theme='Navidad', weight=4000, package='Canasta')
g8.save()
